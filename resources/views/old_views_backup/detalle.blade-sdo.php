...
<div class="container">
   ...
   <nav aria-label="breadcrumb" class="bg-light p-2 rounded shadow-sm">
        ...
        <div class="gallery row g-2 mb-4">
            @foreach ($imagenes as $img)
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    ...
                    @else
                        <img src="{{ asset('storage/' . $img) }}" class="img-fluid rounded shadow" alt="{{ $producto->nombre }}">
                    @endif
                </div>
            @endforeach
        </div>
    ...
    <p>Precio: <strong>{{ $producto->precio }} USD</strong></p>

    @if($producto->precio_oferta)
        <p>Oferta: <strong style="color: red">{{ $producto->precio_oferta }} USD</strong></p>
    @endif
    ...
    <div class="acciones mb-4">
        ...
        <a href="{{ route('cotizacion.solicitar', $producto->id) }}" class="btn btn-outline-secondary ms-2">📩 Solicitar Cotización</a>
