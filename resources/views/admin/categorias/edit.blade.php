            ...
            <form action="{{ route('admin.categorias.update', $categoria) }}" method="POST">
                ...
                <div id="bloqueOferta">
                    <div class="mb-3">
                        ...
                        <input type="text" name="etiquetaOferta" class="form-control" maxlength="255" placeholder="Ej: Por día de la juventud" value="{{ old('etiquetaOferta', $categoria->etiquetaOferta ?? '') }}">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" name="fechaInicioOferta" class="form-control" value="{{ old('fechaInicioOferta', isset($categoria->fechaInicioOferta) && $categoria->fechaInicioOferta ? \Carbon\Carbon::parse($categoria->fechaInicioOferta)->format('Y-m-d') : '') }}">
