                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="email" name="email2" class="form-control @error('email2') is-invalid @enderror"
                               value="{{ old('email2', $proveedor->email2) }}">
                        @error('email2')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="url" name="web" class="form-control @error('web') is-invalid @enderror"
                               value="{{ old('web', $proveedor->web) }}" placeholder="https://">
                        @error('web')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select id="pais" name="pais_id" class="form-select @error('pais_id') is-invalid @enderror">
                            ...
                            @foreach($paises as $pais)
                                <option value="{{ $pais->id }}" {{ old('pais_id', $proveedor->pais_id) == $pais->id ? 'selected' : '' }}>
                                    {{ $pais->nombre }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select id="estado" name="departamento_id" class="form-select @error('departamento_id') is-invalid @enderror">
                            ...
                            @foreach($departamentos as $dep)
                                <option value="{{ $dep->id }}" {{ old('departamento_id', $proveedor->departamento_id) == $dep->id ? 'selected' : '' }}>
                                    {{ $dep->nombre }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select id="provincia" name="provincia_id" class="form-select @error('provincia_id') is-invalid @enderror">
                            ...
                            @foreach($provincias as $prov)
                                <option value="{{ $prov->id }}" {{ old('provincia_id', $proveedor->provincia_id) == $prov->id ? 'selected' : '' }}>
                                    {{ $prov->nombre }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select id="distrito" name="distrito_id" class="form-select @error('distrito_id') is-invalid @enderror">
                            ...
                            @foreach($distritos as $dis)
                                <option value="{{ $dis->id }}" {{ old('distrito_id', $proveedor->distrito_id) == $dis->id ? 'selected' : '' }}>
                                    {{ $dis->nombre }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="url" name="facebook" class="form-control @error('facebook') is-invalid @enderror"
                               value="{{ old('facebook', $proveedor->facebook) }}" placeholder="https://facebook.com/...">
                        @error('facebook')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="url" name="instagram" class="form-control @error('instagram') is-invalid @enderror"
                               value="{{ old('instagram', $proveedor->instagram) }}" placeholder="https://instagram.com/...">
                        @error('instagram')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select id="categoria" name="categoria_id" class="form-select @error('categoria_id') is-invalid @enderror"
                                data-selected="{{ old('categoria_id', $proveedor->categoria_id) }}">
                            <option value="">Seleccionar</option>
                            @foreach($categorias as $cat)
                                <option value="{{ $cat->id }}" {{ old('categoria_id', $proveedor->categoria_id) == $cat->id ? 'selected' : '' }}>
                                    {{ $cat->categoria }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select id="subcategoria" name="subcategoria_id" class="form-select @error('subcategoria_id') is-invalid @enderror"
                                data-selected="{{ old('subcategoria_id', $proveedor->subcategoria_id) }}">
                            <option value="">Seleccionar</option>
                            @foreach($subcategorias as $sub)
                                <option value="{{ $sub->id }}" {{ old('subcategoria_id', $proveedor->subcategoria_id) == $sub->id ? 'selected' : '' }}>
                                    {{ $sub->subcategoria }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <textarea name="descripcion" class="form-control @error('descripcion') is-invalid @enderror"
                                  rows="4">{{ old('descripcion', $proveedor->descripcion) }}</textarea>
                        @error('descripcion')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
