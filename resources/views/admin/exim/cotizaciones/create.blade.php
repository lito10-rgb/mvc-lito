...
@section('title', 'Nueva Cotización - EXIM')
...
<div class="container-fluid py-4">
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body">
            <form action="{{ route('admin.exim.cotizaciones.store') }}" method="POST">
                @csrf
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="validez_dias" class="form-control @error('validez_dias') is-invalid @enderror"
                               value="{{ old('validez_dias', 30) }}" min="1" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" step="0.01" name="utilidad_porcentaje" class="form-control @error('utilidad_porcentaje') is-invalid @enderror"
                               value="{{ old('utilidad_porcentaje', 10) }}" min="0" required>
