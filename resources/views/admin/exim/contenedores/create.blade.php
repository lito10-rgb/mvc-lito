...
@section('title', 'Nuevo Contenedor - EXIM')

@section('content')
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3 class="fw-bold">Nuevo Contenedor</h3>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body">
            <form action="{{ route('admin.exim.contenedores.store') }}" method="POST">
                @csrf
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <select name="tipo" class="form-select @error('tipo') is-invalid @enderror" required>
                            <option value="20ft" {{ old('tipo') === '20ft' ? 'selected' : '' }}>20ft</option>
                            <option value="40ft" {{ old('tipo') === '40ft' ? 'selected' : '' }}>40ft</option>
                            <option value="40hq" {{ old('tipo') === '40hq' ? 'selected' : '' }}>40hq</option>
                        </select>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" step="0.01" name="capacidad_max_kg" class="form-control @error('capacidad_max_kg') is-invalid @enderror"
                               value="{{ old('capacidad_max_kg') }}" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="pallets_max" class="form-control @error('pallets_max') is-invalid @enderror"
                               value="{{ old('pallets_max') }}" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" step="0.01" name="flete_maritimo" class="form-control @error('flete_maritimo') is-invalid @enderror"
                               value="{{ old('flete_maritimo', 0) }}" min="0" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" step="0.01" name="seguro" class="form-control @error('seguro') is-invalid @enderror"
                               value="{{ old('seguro', 0) }}" min="0" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" step="0.01" name="gastos_portuarios" class="form-control @error('gastos_portuarios') is-invalid @enderror"
                               value="{{ old('gastos_portuarios', 0) }}" min="0" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" step="0.01" name="documentacion" class="form-control @error('documentacion') is-invalid @enderror"
                               value="{{ old('documentacion', 0) }}" min="0" required>
