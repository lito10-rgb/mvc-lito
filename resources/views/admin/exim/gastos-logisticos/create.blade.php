...
@section('title', 'Nuevo Gasto Logístico - EXIM')

@section('content')
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3 class="fw-bold">Nuevo Gasto Logístico</h3>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body">
            <form action="{{ route('admin.exim.gastos-logisticos.store') }}" method="POST">
                @csrf
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="nombre" class="form-control @error('nombre') is-invalid @enderror"
                               value="{{ old('nombre') }}" required placeholder="Ej: Almacenaje">
