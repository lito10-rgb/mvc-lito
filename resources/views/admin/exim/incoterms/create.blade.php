...
@section('title', 'Nuevo Incoterm - EXIM')

@section('content')
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3 class="fw-bold">Nuevo Incoterm</h3>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body">
            <form action="{{ route('admin.exim.incoterms.store') }}" method="POST">
                @csrf
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="codigo" class="form-control @error('codigo') is-invalid @enderror"
                               value="{{ old('codigo') }}" maxlength="3" required placeholder="Ej: FOB">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="nombre" class="form-control @error('nombre') is-invalid @enderror"
                               value="{{ old('nombre') }}" required placeholder="Ej: Free On Board">
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="incluye_transporte_interno" value="1"
                                           {{ old('incluye_transporte_interno') ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="incluye_flete_maritimo" value="1"
                                           {{ old('incluye_flete_maritimo') ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="incluye_aduanas_origen" value="1"
                                           {{ old('incluye_aduanas_origen') ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="incluye_aduanas_destino" value="1"
                                           {{ old('incluye_aduanas_destino') ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="incluye_transporte_destino" value="1"
                                           {{ old('incluye_transporte_destino') ? 'checked' : '' }}>
