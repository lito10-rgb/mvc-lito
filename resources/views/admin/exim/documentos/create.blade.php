...
@section('title', 'Nuevo Documento - EXIM')

@section('content')
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3 class="fw-bold">Nuevo Documento</h3>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body">
            <form action="{{ route('admin.exim.documentos.store') }}" method="POST">
                @csrf
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="tipo" class="form-select @error('tipo') is-invalid @enderror" required>
                            ...
                            <option value="conocimiento_embarque" {{ old('tipo') === 'conocimiento_embarque' ? 'selected' : '' }}>Conocimiento de Embarque</option>
                            <option value="packing_list" {{ old('tipo') === 'packing_list' ? 'selected' : '' }}>Packing List</option>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="numero_documento" class="form-control @error('numero_documento') is-invalid @enderror"
                               value="{{ old('numero_documento') }}" required placeholder="Ej: FAC-001-2025">
