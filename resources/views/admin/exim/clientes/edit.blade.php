...
@section('title', 'Editar Cliente - EXIM')
...
<div class="container-fluid py-4">
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body">
            <form action="{{ route('admin.exim.clientes.update', $cliente) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="empresa" class="form-control @error('empresa') is-invalid @enderror"
                               value="{{ old('empresa', $cliente->empresa) }}" required>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="whatsapp" class="form-control @error('whatsapp') is-invalid @enderror"
                               value="{{ old('whatsapp', $cliente->whatsapp) }}" placeholder="+51 999 999 999">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="idioma" class="form-control @error('idioma') is-invalid @enderror"
                               value="{{ old('idioma', $cliente->idioma) }}" placeholder="Ej: Español">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="moneda_preferida" class="form-select @error('moneda_preferida') is-invalid @enderror">
                            ...
                            @foreach($monedas as $moneda)
                                <option value="{{ $moneda->id }}" {{ old('moneda_preferida', $cliente->moneda_preferida) == $moneda->id ? 'selected' : '' }}>
