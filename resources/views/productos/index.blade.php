                ...
                <div class="card shadow-sm h-100">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        @elseif($producto->enOferta)
                            <p class="fw-bold fs-5"><span class="text-muted text-decoration-line-through me-1">S/ {{ number_format($producto->precio, 2) }}</span><span class="text-danger">S/ {{ number_format($producto->precioFinal, 2) }}</span> <span class="badge text-bg-danger">{{ $producto->descuentoEfectivo }}%</span></p>
                        @else
